...
rumor_terms = {
    ...
    'windsor_dam': {
        '$and': [
            {'text': re.compile('dam ', re.IGNORECASE)},
            {'text': re.compile('break|fail|breach', re.IGNORECASE)},
            {'text': re.compile('windsor', re.IGNORECASE)}
        ]
    },
    ###China Explosion##
    'china_pentagon': {
        '$and': [
            {'text': re.compile(
                'pentagon|currency|weapon|rod of god', re.IGNORECASE)},
    ...
    'chatanooga_isis': {
        '$and': [
            ...
            {'text': re.compile(
                'predict|warn|fore|mention|time', re.IGNORECASE)},
